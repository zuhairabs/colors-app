export default [
  {
    ...
    colors: [
      ...
      { name: "sunflower", color: "#e8bc0d" }
    ]
  },
  {
    paletteName: "Default UI Colors v1",
    id: "default-ui-colors-v1",
    emoji: "🤙",
    colors: [
